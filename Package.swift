...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.1.0-rc.14.xcframework.zip",
			checksum: "56b7035ee513c7e3d1401d323ff70fac303cdabf9e1ec095bfc5d73a5247a965"
		)
	]
)