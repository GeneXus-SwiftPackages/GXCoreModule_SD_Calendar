...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.8.xcframework.zip",
			checksum: "3e7de97a4b2f6e3f97b835cf198dd4ece12c453330ad4c5c02f19d32740dfe1d"
		)
	]
)