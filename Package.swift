...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-3.1.0.xcframework.zip",
			checksum: "f369858c238383fe7956fbc45482e0dba44ce0301cc230e780492725e8383937"
		)
	]
)