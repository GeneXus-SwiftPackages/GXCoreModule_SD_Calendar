...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.18.xcframework.zip",
			checksum: "1cc19c6c11e8c417197c1da747e25217dbd1b0e52dfeb7212fc3b464af7714a3"
		)
	]
)