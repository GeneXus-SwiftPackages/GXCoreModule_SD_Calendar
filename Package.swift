...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.1.2.xcframework.zip",
			checksum: "b10f7fa3629f4530f40e969e5e2582851e698b67c743c5ceac7ab920b62cf0c7"
		)
	]
)