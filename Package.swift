...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.2.0-rc.36.xcframework.zip",
			checksum: "ab78dc18e13727179d2ab94c42a3baa7d832d679d52a6aa1a569f842667918ce"
		)
	]
)