...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.26.xcframework.zip",
			checksum: "157ce9259a8e0983851623141a2e98f307bf72795e777666c335ce22cb625383"
		)
	]
)