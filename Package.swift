...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.24.xcframework.zip",
			checksum: "c8ec6b0aa859b3ae788748784a35d32eb18b2dfa0d5ff5200c2553799b2cf67a"
		)
	]
)