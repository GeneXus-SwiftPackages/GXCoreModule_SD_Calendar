...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.7.xcframework.zip",
			checksum: "e55c69dca9b4eda9cd9c327049b0ca4c0e4400b59c2e9675180fd9af5719e553"
		)
	]
)