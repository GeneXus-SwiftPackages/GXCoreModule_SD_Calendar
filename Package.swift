...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.1.0-rc.1.xcframework.zip",
			checksum: "e9ae35409acc334ec34c42d2b1556b6524cfa55e243e368140973b9e5b555344"
		)
	]
)