...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.26.xcframework.zip",
			checksum: "583da82eee676480807a2bcbfe0d3f1140b87884bde2f2eb0a04206f0bd5e4df"
		)
	]
)