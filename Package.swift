...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.22.xcframework.zip",
			checksum: "da74a238e4184995ceac9ebf84fc3492bac4f5cb6adf2c52428490129100eeb1"
		)
	]
)