...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.36.xcframework.zip",
			checksum: "8cda3c1c8b80b04eb1113c748eead6646390a4a740c02bf28524062676af0143"
		)
	]
)