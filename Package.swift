...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.0.0-beta.37.xcframework.zip",
			checksum: "2f271456a3bd0d3db9f7de90026596d2239b08cd80ffe2fb65a5b567e7469896"
		)
	]
)