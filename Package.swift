...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.9.xcframework.zip",
			checksum: "1d4c1d52311f20178dde067b6cb6069ea2465d000716370715b3c7bb04b6f96d"
		)
	]
)