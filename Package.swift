...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.2.xcframework.zip",
			checksum: "26b441b758406ef2e362dbad2786525c52b765d6226b3e02f7d9c7be4e9cf2d1"
		)
	]
)