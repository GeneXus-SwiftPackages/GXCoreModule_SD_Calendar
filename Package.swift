...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.4.0-rc.1.xcframework.zip",
			checksum: "8295112042b70ec2f1dd04e5c1da704c597101dfa8ecd2908c4d76188aec6b33"
		)
	]
)