...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.20.xcframework.zip",
			checksum: "bd4059b39156ad19ae86f5f1338e893d91ce9353b0480f0be1ddf5243e83f029"
		)
	]
)