...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.7.xcframework.zip",
			checksum: "b9152a500f8f3e23d84868d9e41a0d8eb482893068f09311f54f7be3bafae2d0"
		)
	]
)