...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-5.0.0-beta.4.xcframework.zip",
			checksum: "181feca13d8067bef4ba6685322636af26b746f64d0514c45d2c94553524af23"
		)
	]
)