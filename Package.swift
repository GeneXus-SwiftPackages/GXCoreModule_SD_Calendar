...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.27.xcframework.zip",
			checksum: "2cb230ed3bea167a13cd041b02f1852f3743781705407979a1dedd99b9d7f3d4"
		)
	]
)