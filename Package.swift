...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.18.xcframework.zip",
			checksum: "495a097139d72c6a653b4819b0acba5872c4e24d507ee7ecac24e137a791006e"
		)
	]
)