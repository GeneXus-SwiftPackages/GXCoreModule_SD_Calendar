...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.19.xcframework.zip",
			checksum: "04d8d9e5ed867a14df19d12600297270c93886b58b6908c03a5751e7882b1bea"
		)
	]
)