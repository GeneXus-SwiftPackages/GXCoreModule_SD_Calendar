...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-5.0.0-beta.5.xcframework.zip",
			checksum: "6972fee13ae44c0b5293a65c39d8e91b1b8cc7c3f2cf81cb0ae9d9726cf074f6"
		)
	]
)