...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.15.xcframework.zip",
			checksum: "16d6386f9332456f7affef6090e491fe7428977dc89df31cd4587a9708d8dda5"
		)
	]
)