...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.28.xcframework.zip",
			checksum: "ce35c83c6157010d8604fffe74b06710214abfc2fa47d2bbbbba6c46ecd77d34"
		)
	]
)