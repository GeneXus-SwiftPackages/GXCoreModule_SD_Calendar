...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-2.0.17.xcframework.zip",
			checksum: "e8400e08fcaf80ac71bbd28d46ccdd36e03a8d5eead9b7f8c4e84456179b84ec"
		)
	]
)