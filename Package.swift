...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.17.xcframework.zip",
			checksum: "b39ae441c853e950c9d9f724e1edcbc03c7fdbf5379336259407dfa322de139c"
		)
	]
)