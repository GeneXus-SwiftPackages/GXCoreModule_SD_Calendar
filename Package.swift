...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.5.0-rc.26.xcframework.zip",
			checksum: "32a68daec6149d813eca83eeb5b3743f0aa8187272ede28482f79a00aa509741"
		)
	]
)