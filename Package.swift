...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.31.xcframework.zip",
			checksum: "622e13f8f3cb2cafd6b2dbe5d7e36bc805e31b2e041236f91a80c5fd5bfb62a9"
		)
	]
)