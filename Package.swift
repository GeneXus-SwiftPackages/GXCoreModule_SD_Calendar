...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-3.0.4.xcframework.zip",
			checksum: "16393e9c297ba1e6c3bc52e7afab7b3ebb1e4721665fdd42f453e14a0900a333"
		)
	]
)