...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.17.xcframework.zip",
			checksum: "4ae57a9ace8bcf59811a6739ab4197f31b0c19d9066f032e3c83068b2420c0c0"
		)
	]
)