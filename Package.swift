...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.24.xcframework.zip",
			checksum: "856eab087c9f876d0472f2c7b8d887b3ef795d1fcc0a9240065b47745a44f050"
		)
	]
)