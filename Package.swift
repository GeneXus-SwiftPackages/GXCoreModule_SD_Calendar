...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.0.0-beta.23.xcframework.zip",
			checksum: "54a392662f571f01ac2fcfc38e2a340d2f86d08f0040637dc1cf1da9e3489094"
		)
	]
)