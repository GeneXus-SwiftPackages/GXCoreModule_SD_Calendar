...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-2.2.0-rc.3.xcframework.zip",
			checksum: "1135b7472cd316db5d116772af3440158267ef8edc8092037d9f392a53234fe4"
		)
	]
)