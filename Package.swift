...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.2.0-beta.15.xcframework.zip",
			checksum: "7cc9efd29a1feffcb6c7b861de9148159a1f75f663d5dc775191c8a24ee9b565"
		)
	]
)