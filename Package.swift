...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.25.xcframework.zip",
			checksum: "2b61b3eba0ef56fe27aa7d9098a51df26db44797ffe9127fffb8bf92040766f5"
		)
	]
)