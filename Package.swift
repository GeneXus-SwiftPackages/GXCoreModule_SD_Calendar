...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.37.xcframework.zip",
			checksum: "1ebdc89f5a6ee77714a64fe1b90b3a31508918096e4521fb51069d3137ca604e"
		)
	]
)