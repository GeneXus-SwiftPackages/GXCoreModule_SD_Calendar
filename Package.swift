...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-3.2.0-rc.0.xcframework.zip",
			checksum: "6776fe8bf25de8844f6d2e91095d374fb190feceb9c99a7e51adb7a89f25b99f"
		)
	]
)