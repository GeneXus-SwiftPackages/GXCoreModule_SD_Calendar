...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-3.2.0-rc.9.xcframework.zip",
			checksum: "365abeaa6911dd5e991a4fa9fcf21be0129aec495641897b42ebad3b94bb1d64"
		)
	]
)