...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.16.xcframework.zip",
			checksum: "8925b069a6a8d8d83d7d58adf557dc3f5cbf3ed2e16b13bd9b580fda78276fa8"
		)
	]
)