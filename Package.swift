...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.11.xcframework.zip",
			checksum: "3f46a3c15baabd1c6a3408518969c13eb62bbb8a20a9ba2c38bea40855f8e9d5"
		)
	]
)