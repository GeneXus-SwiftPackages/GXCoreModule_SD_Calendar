...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.1.0-beta.795.xcframework.zip",
			checksum: "85876245a30028fa901bcb8399c4a81f77e57fb4f340d33b8de6151a9d8b3232"
		)
	]
)