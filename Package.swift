...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.1.0-rc.22.xcframework.zip",
			checksum: "766afd2c51e46146801385a18d5a9d7cb2b2a7c6531cda6398d5bf58f2505a32"
		)
	]
)