...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.1.0-rc.4.xcframework.zip",
			checksum: "31df82a0fe987ff8c7be8ed9447dfa8bea95a538973d4243a5cf2313579a2484"
		)
	]
)