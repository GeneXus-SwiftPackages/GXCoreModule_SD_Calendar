...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-3.0.7.xcframework.zip",
			checksum: "399824f1004c22ba473697997b7906b2a7fcf50ef99db08bb55ff9f7c6575226"
		)
	]
)