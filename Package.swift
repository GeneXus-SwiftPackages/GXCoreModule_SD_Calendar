...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.4.26.xcframework.zip",
			checksum: "07547641250d7d0a71e4ecc287ef2ba60876fc259b54a4d8125f2d88cbdca7e0"
		)
	]
)