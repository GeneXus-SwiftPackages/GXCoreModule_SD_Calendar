...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.3.xcframework.zip",
			checksum: "154c0255c7ec1a03c7935a4db4f9f527073bcf34530aa26404720bb3362db3dc"
		)
	]
)