...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.0.xcframework.zip",
			checksum: "82cff0458ddb05cd9b4b08eadc532ff3ecc54e55f1b65156d6c724e93c6ad374"
		)
	]
)