...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.30.xcframework.zip",
			checksum: "6bf730648302c9bb2bd70b036b4afa18f1827ac6837df63f13400a33217f103b"
		)
	]
)