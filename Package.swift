...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.4.30.xcframework.zip",
			checksum: "c198f1ff8fa69ea88299319aeeb01480a31dec0b1d125732347b68a4ec10ed33"
		)
	]
)