...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.15.xcframework.zip",
			checksum: "b3ca67ea804f807bbbc16388f027602e251f04dc83f387184f6a68c212d52e9a"
		)
	]
)