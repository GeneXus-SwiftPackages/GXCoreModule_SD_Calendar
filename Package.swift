...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.3.xcframework.zip",
			checksum: "6d715633ed96ff04ffb3e767ea05f2d3f3f1c05f41b0cd6bd0bc3536ea58dff6"
		)
	]
)