...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.18.xcframework.zip",
			checksum: "0ce2cf645bcf743362aaa782dd8c3b0103a714587353089b4e2ffc2f6972e99e"
		)
	]
)