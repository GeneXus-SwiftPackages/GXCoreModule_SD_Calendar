...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.15.xcframework.zip",
			checksum: "85cc72c05d07673288017e248c868b9bcd88db7c232f4efe96dc73541a3f0941"
		)
	]
)