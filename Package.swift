...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.17.xcframework.zip",
			checksum: "a1296cc3e2e0cd7d31e9052ddc1d184ddb0f767ae3d3ceb16351b8d3f2a38444"
		)
	]
)