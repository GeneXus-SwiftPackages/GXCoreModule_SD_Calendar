...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.10.xcframework.zip",
			checksum: "3f52d46fd073062c6b6732f03ac3fb88b1f76f9fb12f4fba5b5e98cd30d068d4"
		)
	]
)