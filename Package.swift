...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.10.xcframework.zip",
			checksum: "68119b2ccffbc53d3478ef2347b3981e99ce872f77471eb41dbf8096f65cd291"
		)
	]
)