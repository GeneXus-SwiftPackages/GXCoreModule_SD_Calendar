...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.14.xcframework.zip",
			checksum: "55f11b6e16fe48087e191a1622347e72f7d29df52604bd9d9988f93f75a63ae8"
		)
	]
)