...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.6.xcframework.zip",
			checksum: "2099282bcf9e458bd7c85dab2b1c284f1cdb0af7fc03d9d1f6dc2d0da3698f00"
		)
	]
)