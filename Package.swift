...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.2.0-rc.0.xcframework.zip",
			checksum: "d90743af625cb4ccb774c9b102cb0715edf2649f5b1ab00fccb00c84c4c2ad2e"
		)
	]
)