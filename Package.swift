...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.5.xcframework.zip",
			checksum: "6eab776e5b1b7549788a61757ff88d6b7bacf94e35cdad856fc34b8945ef9460"
		)
	]
)