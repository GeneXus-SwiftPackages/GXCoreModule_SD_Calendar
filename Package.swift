...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.16.xcframework.zip",
			checksum: "d091d7f45d316f840f6ba91426d5fc14b7ba7b8f233f943a4278c86caa9ff534"
		)
	]
)