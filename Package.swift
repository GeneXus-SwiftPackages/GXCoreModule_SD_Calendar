...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.6.xcframework.zip",
			checksum: "448bbefb279ccf987b8dfb1da4817b1aee823755ab0ce7dfabe69b5f8c8a7278"
		)
	]
)