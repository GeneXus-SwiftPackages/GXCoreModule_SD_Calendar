...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.40.xcframework.zip",
			checksum: "37c4265fbee305fb3e1a7fa6b08573bd40317112161ddf19bf9affd3b86fa25d"
		)
	]
)