...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-2.1.0.xcframework.zip",
			checksum: "eefbfaf9c08d7c0a11de296457ef6e1d0fa5b4f5d22120b92d00b03358b4ffaa"
		)
	]
)