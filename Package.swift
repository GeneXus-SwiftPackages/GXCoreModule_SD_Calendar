...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.14.xcframework.zip",
			checksum: "05fb5df8cb8e69f74532b32feaf27c3bbd9c96d7812ac0eaf057ca2853722471"
		)
	]
)