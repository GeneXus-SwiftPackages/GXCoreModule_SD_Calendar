...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-2.0.0-rc.34.xcframework.zip",
			checksum: "7cda3ccbbb116f389bc8c3159a11699a59296e39cdcaf4a42acca637aa95d28f"
		)
	]
)