...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.2.0-beta.17.xcframework.zip",
			checksum: "4a86ff93cc1f140570d18b1b5338bd19e57eb5145ff578882cf0fd1a25f72684"
		)
	]
)