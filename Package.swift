...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.6.0-beta.1.xcframework.zip",
			checksum: "cb13d3db9a25f66aa082df99982cd13eebc8ca995fbb501d3e00d8d87797a83a"
		)
	]
)