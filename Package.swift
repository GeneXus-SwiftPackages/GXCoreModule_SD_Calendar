...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.21.xcframework.zip",
			checksum: "4bc6e7c969020d0ec4e93cb5a925a65f6a0261f4ffdf4b72090482caf8d90b1d"
		)
	]
)