...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.4.xcframework.zip",
			checksum: "6679d3a693ecaa46d064ba8b526915182088a37d6f6c61105311e910f7501490"
		)
	]
)