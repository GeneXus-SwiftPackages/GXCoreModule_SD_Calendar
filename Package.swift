...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.8.xcframework.zip",
			checksum: "c95f05e15e3bc4c77bf026fb40cbb037bcf2b13f452f09d9d68ae8b6064a0bd0"
		)
	]
)