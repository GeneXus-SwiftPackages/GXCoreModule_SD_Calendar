...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.5.xcframework.zip",
			checksum: "29c2c43f30128405daa358f38784da7ef0f99e1e88faba921fa9c05a14b1c52c"
		)
	]
)