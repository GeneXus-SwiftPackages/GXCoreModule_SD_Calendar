...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.1.0-beta.8.xcframework.zip",
			checksum: "55449ff8ced8e534739b1c72e03b37590a0c1cb3905d3cd764065c6123a01efd"
		)
	]
)