...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.5.xcframework.zip",
			checksum: "4964c43ebb7e193a732e6b3551e73747e3a3696549100cffd12616edae8811e8"
		)
	]
)