...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-2.1.3.xcframework.zip",
			checksum: "2a30f5771fda17c21519c5e8ff7ddae31c272ca932fad92b7d62da2486bb2bf4"
		)
	]
)