...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.1.0-beta.9.xcframework.zip",
			checksum: "ad1cb653061ec8bfcb0c314e55e93d916dc40ddd9a2d114e675b2a418316ec8c"
		)
	]
)