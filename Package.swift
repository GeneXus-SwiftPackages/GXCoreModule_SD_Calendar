...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.37.xcframework.zip",
			checksum: "09bc3f15079bbb6a2232d3e7ea751fd223103501b7f85b9c7141abd5ae82f130"
		)
	]
)