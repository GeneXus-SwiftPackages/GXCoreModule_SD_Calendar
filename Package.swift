...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.31.xcframework.zip",
			checksum: "8a753fb67be3c2ba6c2ade35ddf94462831aef59bdb7d21934628e74b8912ad8"
		)
	]
)