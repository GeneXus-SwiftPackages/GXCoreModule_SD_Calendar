...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.3.0-rc.13.xcframework.zip",
			checksum: "d72cd461a8b57feeba5d052036a32e3d318e86d4c3640819c351e2d7b43254fd"
		)
	]
)