...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.2.0-beta.25.xcframework.zip",
			checksum: "962d602373fe44cf565226fcb098aaf9023767cf6c58b8b3765984b8f010417e"
		)
	]
)