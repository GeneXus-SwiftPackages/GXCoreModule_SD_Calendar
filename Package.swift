...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.1.0-beta.7.xcframework.zip",
			checksum: "7b269fdab293aa6fcd047723ebfe9bd55495528319b9126dfbceb0e0e6980e1a"
		)
	]
)