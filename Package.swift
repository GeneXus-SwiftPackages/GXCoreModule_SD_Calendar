...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.30.xcframework.zip",
			checksum: "de721f7f14983e8facd3206426d580a1c74ea10b57b5c5a387be6636aede16ac"
		)
	]
)