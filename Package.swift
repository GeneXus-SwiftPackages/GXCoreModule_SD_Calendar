...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.17.xcframework.zip",
			checksum: "c679e2cf4c5668a0035611bdce8fef1e57055aa6f82947f7a277db0e0998a05c"
		)
	]
)