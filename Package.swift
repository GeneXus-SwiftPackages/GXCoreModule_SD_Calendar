...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.2.xcframework.zip",
			checksum: "70d77e0cffe3aff6cdf00a1988019fcfbfdca6ac2444350219ada2b6738613fe"
		)
	]
)