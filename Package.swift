...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.0.0-beta.45.xcframework.zip",
			checksum: "ca865486b9e2eb92fabba68923b489bd13f75425a03f4308b6eb679a46717fed"
		)
	]
)