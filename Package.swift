...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.19.xcframework.zip",
			checksum: "dca34a187db1d47d5dcd4d26895609608af72d2576ccb8d5f79232c5f0b1120a"
		)
	]
)