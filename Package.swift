...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.6.xcframework.zip",
			checksum: "6ca8da7638bd10534c4f8d988d53037421652a4135954320f93724755358e81f"
		)
	]
)