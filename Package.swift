...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.10.xcframework.zip",
			checksum: "788bc807c463e06484f180d6852c6d3d4976e15dbfc24e697deaed460e173ffc"
		)
	]
)