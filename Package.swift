...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.1.0-beta.25.xcframework.zip",
			checksum: "9acf1865491872d8db7034abf3e88142a1d3616a45b340b0a8cde6e668b017a0"
		)
	]
)