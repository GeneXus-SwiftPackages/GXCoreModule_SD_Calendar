...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.4.xcframework.zip",
			checksum: "5e1d216ad474510648a54b53cab3d78eaa18c7000811678e8d0f763b57c4390d"
		)
	]
)