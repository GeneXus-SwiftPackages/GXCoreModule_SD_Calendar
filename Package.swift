...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.9.xcframework.zip",
			checksum: "550e977e69b9a3227324b775c5b575e4276171878e6db4c47a34367078416abd"
		)
	]
)