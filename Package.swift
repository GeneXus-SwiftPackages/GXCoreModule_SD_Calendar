...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.0.0-beta.20230630152236.xcframework.zip",
			checksum: "683d2a141b74bf8d9981c838f012b97b53b177e91ad55256b37884abfda8bb7f"
		)
	]
)