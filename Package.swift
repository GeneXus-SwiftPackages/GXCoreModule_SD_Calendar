...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.5.0-rc.2.xcframework.zip",
			checksum: "a18d889e9c37cf9be4f6ce71e841b6a470d25ccf51f2912cb342976fd554b8cd"
		)
	]
)