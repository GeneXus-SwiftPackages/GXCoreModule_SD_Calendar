...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.34.xcframework.zip",
			checksum: "d1c3594d2dfa940a5f7410c31dcdb7589bbcbd8fe54ec7620570c403d7f96b60"
		)
	]
)