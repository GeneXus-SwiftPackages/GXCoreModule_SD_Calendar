...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.2.0-beta.12.xcframework.zip",
			checksum: "4967966328af3e159e5819c7ed1adc6cf903a961d6611ea959fa3afc3f3fed14"
		)
	]
)