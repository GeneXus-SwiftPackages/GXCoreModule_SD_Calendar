...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.3.xcframework.zip",
			checksum: "3c6fd44d0ffb3843840691d6e716b31727aff59ba0d5a6b01ec7ebc278e03605"
		)
	]
)