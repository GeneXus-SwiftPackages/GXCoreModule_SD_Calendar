...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.23.xcframework.zip",
			checksum: "06b2a5ef929b753d91f8708dac1cb6ec63d23bd8b66ce82856d8dfc412ba4735"
		)
	]
)