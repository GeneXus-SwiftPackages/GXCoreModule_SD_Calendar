...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.18.xcframework.zip",
			checksum: "3158956997b3cfb5e07d45060538076487a28b94000832309bd2a71b59b13503"
		)
	]
)