...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-2.1.0-rc.25.xcframework.zip",
			checksum: "ee7645f8f2387a2ace68ddeef09480083997cdf258b3d20b1e18a5c2b2adcfed"
		)
	]
)