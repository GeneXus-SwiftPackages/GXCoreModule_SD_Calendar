...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.24.xcframework.zip",
			checksum: "a389eadd2d287d8cb094572c9f6cb60831013f0cba771cfd66eba84131209a4c"
		)
	]
)