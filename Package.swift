...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-5.0.0-rc.0.xcframework.zip",
			checksum: "a38807670f15f00bd6a88330f0bfe5d7e365f035311d04efcc9e1af35a26548c"
		)
	]
)