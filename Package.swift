...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-3.0.1.xcframework.zip",
			checksum: "882abbbc8f70d4705db63a0dd8be3b67fcdd5bf6ee75a0ed830b9386c971f1de"
		)
	]
)