...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.2.xcframework.zip",
			checksum: "c583b8af0d14ca4b8e38d08f45d45491165ced9fe429d338c134dcefe5ba4955"
		)
	]
)