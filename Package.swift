...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.1.0-rc.8.xcframework.zip",
			checksum: "00bc984bb3705ba2aff1d210ea61b5ad3781e4c653145f91f8732489ba2384d2"
		)
	]
)