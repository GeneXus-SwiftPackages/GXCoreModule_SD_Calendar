...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.1.0.xcframework.zip",
			checksum: "e43f87196772af6c985831ed220c04eb30113b775abed98bfd8ee81bd9701f26"
		)
	]
)