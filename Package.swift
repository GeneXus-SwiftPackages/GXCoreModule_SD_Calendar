...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.0.0-beta.49.xcframework.zip",
			checksum: "acefc6e79682b7908c06664e105f3931cf521734123a626a23e5769cdf190f1c"
		)
	]
)