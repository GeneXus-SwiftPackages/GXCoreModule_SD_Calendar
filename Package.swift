...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.1.0-beta.10.xcframework.zip",
			checksum: "1e8a197e464d35d4174d5ec334f6634e4d9430879161516e00ea468f2e1c3623"
		)
	]
)