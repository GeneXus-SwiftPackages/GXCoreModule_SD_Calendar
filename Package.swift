...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.2.0-rc.37.xcframework.zip",
			checksum: "cc2e722d816ffc7482969717385290dbac1b75b04d8eaaf6a9703d093c1e4ffd"
		)
	]
)