...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.20.xcframework.zip",
			checksum: "4f37506b3f6c185db460dfe1510e02e50e1b374ec771576808ee8557745b4129"
		)
	]
)