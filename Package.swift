...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.9.xcframework.zip",
			checksum: "0d4b0d8b4c4b379bbac17afbc331cd9a9cecbd1a9fe37627059b220da3ebdbc6"
		)
	]
)