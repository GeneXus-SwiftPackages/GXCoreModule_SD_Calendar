...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.7.xcframework.zip",
			checksum: "4c157118ccb6398a02c1975b7e3f28780d3a57b83295c3d4c84a3e43c043af2b"
		)
	]
)