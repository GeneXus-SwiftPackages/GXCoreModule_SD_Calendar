...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.19.xcframework.zip",
			checksum: "80ece76e18da41375cd29c34aa095ad3a2797925777d070bd51c480d0d0d5be5"
		)
	]
)