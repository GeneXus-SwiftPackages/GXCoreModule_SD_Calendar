...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.23.xcframework.zip",
			checksum: "258a35e52dc8d7db3a6f3f739c805f49fbe65b5a2048927b8112d265084b4a67"
		)
	]
)