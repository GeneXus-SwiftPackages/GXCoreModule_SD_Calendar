...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.17.xcframework.zip",
			checksum: "ba8e278d126dfdcb02af5e1a0217f68d9c1ed86bfcd006403bc9893a425820aa"
		)
	]
)