...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.1.0-rc.24.xcframework.zip",
			checksum: "251f9c0eb10c1fb58b5151524c92431ac3e203aa7f85f63425354dfa256b85b9"
		)
	]
)