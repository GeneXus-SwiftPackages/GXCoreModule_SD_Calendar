...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.6.xcframework.zip",
			checksum: "83b53e437a29d3e7ffdb398fbb11322fe394926404bb997c051b49a404b4bd0f"
		)
	]
)