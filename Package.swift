...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.6.0-rc.0.xcframework.zip",
			checksum: "59562e8de3b160ef00e2909d5509db8fc6685acff6d18646500dcf8e412e3460"
		)
	]
)