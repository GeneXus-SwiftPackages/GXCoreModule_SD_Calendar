...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.2.xcframework.zip",
			checksum: "3ba2e7a51acdf8f6dad8684c23a0411cc9f278b3452abf51efd3dba37289a1fa"
		)
	]
)