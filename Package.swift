...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.10.xcframework.zip",
			checksum: "6cf70d8a3dafde7ecc143487ba627659ed6d85a476c954b079f3deb785072215"
		)
	]
)