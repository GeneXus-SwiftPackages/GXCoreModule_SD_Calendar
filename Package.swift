...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.0.0-beta.20.xcframework.zip",
			checksum: "0ffcad786e8ff2063cf77ffdc1706c7b3a9cda3c7d232fca26e2d4a8fb415ffb"
		)
	]
)