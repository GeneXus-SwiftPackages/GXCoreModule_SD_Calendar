...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.16.xcframework.zip",
			checksum: "1c18c5d256f51be23bae872ff7f2f7f8c429ad2d9cbf1eb180e48097093ff816"
		)
	]
)