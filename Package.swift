...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.1.xcframework.zip",
			checksum: "762ddc82488ebfa4f514bb4619df931918616895230c7f9df3135790c765643b"
		)
	]
)