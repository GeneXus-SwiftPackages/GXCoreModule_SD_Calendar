...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-2.1.4.xcframework.zip",
			checksum: "17cb460341f0ce9b8e979c88472af1e1224368ade72539fec7d379233c7b5fb5"
		)
	]
)