...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.20.xcframework.zip",
			checksum: "edf5ae40df1bd2315b7bf68a2bf52c434773412e9b70751bc55164272f683578"
		)
	]
)