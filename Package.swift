...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.16.xcframework.zip",
			checksum: "de8f77dbee0db558dd2cfae375f1e7d0528acf01db99e5a3a5d940fb3c1caf5e"
		)
	]
)