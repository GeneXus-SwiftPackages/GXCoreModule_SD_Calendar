...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.7.xcframework.zip",
			checksum: "ebfc3d3c0ef2ffd3e26011542d3873c0e11d2519b87f9641bde4cd20d68ca396"
		)
	]
)