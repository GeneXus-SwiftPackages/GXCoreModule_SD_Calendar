...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.15.xcframework.zip",
			checksum: "0a489e9dca1410565b04dd7f164e1cf70d6b8035129e298d77154a53de7c831e"
		)
	]
)