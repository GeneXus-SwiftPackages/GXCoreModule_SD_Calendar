...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.11.xcframework.zip",
			checksum: "c50d2d3ec99285c88191e06b6d0e569a946aadc95ea76d588040914066a99c15"
		)
	]
)