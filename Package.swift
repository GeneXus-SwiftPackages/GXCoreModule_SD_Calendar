...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.11.xcframework.zip",
			checksum: "4335356440e7aaa3672e246f530d19a409f0e0d6d7973daea4f1ff8033c2f36c"
		)
	]
)