...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.31.xcframework.zip",
			checksum: "b56e749e691e2ebbf1a85e4990c2a15bf9f52c5d4a1102537833a14101c0bb29"
		)
	]
)