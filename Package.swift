...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.32.xcframework.zip",
			checksum: "41fbc747e9999090c809a91562aebca163d6ed9eb94e430699504845e3f8b0bf"
		)
	]
)