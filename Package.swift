...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.11.xcframework.zip",
			checksum: "5be917f2b0e00144bf3121d05080c2f8874c75cde3816a021fa577117c9699ba"
		)
	]
)