...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.0.0-beta.26.xcframework.zip",
			checksum: "5ce7b0a3a1da96978a5ab10a59dc492f3c1ba94f860cb995caabebd199198ebc"
		)
	]
)