...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-2.2.0-rc.1.xcframework.zip",
			checksum: "d3a2fdb6d9268d1314de10b84907e81925257b0a8839e040cd95b949e45528d3"
		)
	]
)