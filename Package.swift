...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.2.0-rc.25.xcframework.zip",
			checksum: "cace90ed0b81f936e90eab7c8269eb9e2c266a27c90716d64ffdade0b30a99ea"
		)
	]
)