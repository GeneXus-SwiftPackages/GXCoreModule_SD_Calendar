...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.33.xcframework.zip",
			checksum: "bae94549a4ff9f837fb2f3c0a5b7a70c09f0866871ad111d26a87c2e0c591c88"
		)
	]
)