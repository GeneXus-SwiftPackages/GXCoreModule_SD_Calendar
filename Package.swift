...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-2.0.18.xcframework.zip",
			checksum: "efddebb1f11c6ccb431a8db1a82534d4fd62ad432b2d8998b7dcab5d2142f3e2"
		)
	]
)