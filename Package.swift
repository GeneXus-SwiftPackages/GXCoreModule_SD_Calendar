...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.4.0-rc.5.xcframework.zip",
			checksum: "89ce0435ea7abba5e41efb7f225d81ef0f25864a3c7aba585d679d1571b66f3d"
		)
	]
)