...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.0.xcframework.zip",
			checksum: "8eeb69e6ab8dabf442f200d559bca6892d6161d24d2157b5b539997e722b85a3"
		)
	]
)