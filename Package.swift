...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.14.xcframework.zip",
			checksum: "12ddb3801e452e84e1fcd169e66e529e849fe2919f875047b588c5ac47a2951c"
		)
	]
)