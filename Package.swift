...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.8.xcframework.zip",
			checksum: "b0483cc58c4290a4033240a1d296cb5f80ef7072d89d79a46e3993be17da0f08"
		)
	]
)