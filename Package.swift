...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.2.0-rc.34.xcframework.zip",
			checksum: "1a99703059d89a4ac16783d4034d5c4371e99f1655679d4b7df009c36358ca63"
		)
	]
)