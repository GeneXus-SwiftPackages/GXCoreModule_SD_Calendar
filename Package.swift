...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.5.16.xcframework.zip",
			checksum: "f3ca61ec9a784063743cdb11b800d75ed49ce5c18fc31d1dc5770885b3cd5b6a"
		)
	]
)