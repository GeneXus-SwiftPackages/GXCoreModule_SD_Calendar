...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.15.xcframework.zip",
			checksum: "caccec5384e4ac6f8527c1f737f7bc830cd1f603e1a70a6854c54b86d846c018"
		)
	]
)