...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.17.xcframework.zip",
			checksum: "a5449ddd34971ec04e22732cccd49399b122a223b6e77aba3d182a35e1119947"
		)
	]
)