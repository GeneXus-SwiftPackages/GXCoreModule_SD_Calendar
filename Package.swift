...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.5.17.xcframework.zip",
			checksum: "919d7e11b7b8b379f182f7b40cf8fa97091de653237398ca531604d5a45f7e1f"
		)
	]
)