...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.11.xcframework.zip",
			checksum: "00e4f013aaccedd8ad302008f314b499dee35484c0de927efed5978dd2c9eb26"
		)
	]
)