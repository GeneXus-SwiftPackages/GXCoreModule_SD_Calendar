...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.19.xcframework.zip",
			checksum: "3380513494c29fab277e47850a2cae549b9c0f8adf6d14b914903261ff545180"
		)
	]
)