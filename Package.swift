...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.32.xcframework.zip",
			checksum: "3be7ade35a4d8b13a0b4ef58599d0b8e6a687ecbe9d36bc4b83152ce863fd948"
		)
	]
)