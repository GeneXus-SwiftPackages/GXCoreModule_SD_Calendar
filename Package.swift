...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.25.xcframework.zip",
			checksum: "cd5cb2c5cd8fd76d8270a054660128bb6fdf8187a8caa6ad7575531486226c01"
		)
	]
)