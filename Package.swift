...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.12.xcframework.zip",
			checksum: "117868b7546227fde2582e880ecd68dc70577c91a31a6400a2b7fc69bd1ee01a"
		)
	]
)