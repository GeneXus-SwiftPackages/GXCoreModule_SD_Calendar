...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.0.0-beta.47.xcframework.zip",
			checksum: "02930883bc9c6fa1551344689ca95c08020060f3df18ea8f75cd79b21cc61fa5"
		)
	]
)