...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.1.0-beta.794.xcframework.zip",
			checksum: "52ed1962f328bd6256c568c497476bbb0512c2779b94d463abded11f379daeeb"
		)
	]
)