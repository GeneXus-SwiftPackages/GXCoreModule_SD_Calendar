...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.1.5.xcframework.zip",
			checksum: "1516621ce399cfc370707784016c38b5d2befbbf213b95e738e8ae4babbbfd0d"
		)
	]
)