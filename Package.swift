...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.24.xcframework.zip",
			checksum: "517b1532e5db56994e9118d6a34d5ce89ca20ef95341860501891272428e7e13"
		)
	]
)