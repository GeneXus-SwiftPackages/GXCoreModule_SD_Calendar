...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.8.xcframework.zip",
			checksum: "1384c1f444f1ca301222aa25baeec885a41c3f748a1961cea1ee15f206218083"
		)
	]
)