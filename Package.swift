...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.27.xcframework.zip",
			checksum: "51f3da557313ec0d96ef546181ee3ac9cad06f836e9c69c30547dd5bc471984f"
		)
	]
)