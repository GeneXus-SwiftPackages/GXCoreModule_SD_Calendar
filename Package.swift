...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.9.xcframework.zip",
			checksum: "28d98a65fe3af71d978fa9f6dcfe45d486ac1b0f93d8fea50fc1de318418c718"
		)
	]
)