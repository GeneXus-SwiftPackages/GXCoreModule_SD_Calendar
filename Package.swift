...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.4.27.xcframework.zip",
			checksum: "ec0c329246979e000120281c7812c71fe6c4ffd695ce53f648b8c4ff6bcc73ff"
		)
	]
)