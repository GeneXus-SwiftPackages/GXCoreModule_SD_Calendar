...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.27.xcframework.zip",
			checksum: "577eff3c14bec40a86237761eb060334082c7bcf7b19368f49e3e8e5812c6642"
		)
	]
)