...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.14.xcframework.zip",
			checksum: "d7f3f637120045eaa438b77e5988be29e45912f4d91c7e1334ee0dc1c33689eb"
		)
	]
)