...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.38.xcframework.zip",
			checksum: "22f8a51179e3a8978a92fa411190e93cdb006c9086108b734124f7a493188694"
		)
	]
)