...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.13.xcframework.zip",
			checksum: "ea96c8573040288f9f91be4c86ef188f74bea4a731ec80f16c26065fbbc0213a"
		)
	]
)