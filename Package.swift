...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.22.xcframework.zip",
			checksum: "70767baf9063b5d71897d9b3196e524a8ee02f8dd1c99532ec7e154adffc686f"
		)
	]
)