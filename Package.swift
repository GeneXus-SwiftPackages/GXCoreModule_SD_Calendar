...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.26.xcframework.zip",
			checksum: "be7b0f15413b443d66c4a848d2d2f7b0215993ffeb264590e96a17acad8d63d0"
		)
	]
)