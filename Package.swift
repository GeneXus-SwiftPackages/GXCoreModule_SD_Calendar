...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.1.xcframework.zip",
			checksum: "f649cbe1a78018242033123bdb9a6bda3a9d29f4c56fcaa1173431ebbac9c316"
		)
	]
)