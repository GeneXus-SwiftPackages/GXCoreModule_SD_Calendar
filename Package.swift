...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.1.0-beta.12.xcframework.zip",
			checksum: "c89a5d91f4dca3e7a11eff65848c49d2dc4d54a175740afc8029d6c1795a8a5e"
		)
	]
)