...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.4.xcframework.zip",
			checksum: "ab2eb5ddf067b3094712df2899063b4960b92bdb2d6ebfb0bf19dedb05dc1ddb"
		)
	]
)