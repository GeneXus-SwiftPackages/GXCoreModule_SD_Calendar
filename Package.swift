...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.35.xcframework.zip",
			checksum: "6db3bfb4e63cd7e84c1e444cd745ba463e8125d2a93b75ead803d2e05bd9dee7"
		)
	]
)