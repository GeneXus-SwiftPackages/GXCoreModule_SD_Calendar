...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.26.xcframework.zip",
			checksum: "048578a916422185f39411a8e800460506a9bc09aa0c15e24f2af9aba2dbadad"
		)
	]
)