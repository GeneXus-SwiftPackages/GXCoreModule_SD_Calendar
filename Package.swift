...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.4.xcframework.zip",
			checksum: "01ed770773fd1afa61a4c93fe426d5cabc86a3dc3ba8d9c695ac4f2a6ce06bd5"
		)
	]
)