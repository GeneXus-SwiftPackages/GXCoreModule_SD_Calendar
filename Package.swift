...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.2.0-rc.29.xcframework.zip",
			checksum: "a87ca4c9559bbe7c4bbb8f8a04b4b22358c1a5050e804800f6a6d5b48d53f4ee"
		)
	]
)