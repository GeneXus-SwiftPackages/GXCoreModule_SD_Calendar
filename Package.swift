...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.23.xcframework.zip",
			checksum: "d7a807e1474762ba4636402e71beb160afe285fa8503968f32ab1f62ebe29b65"
		)
	]
)