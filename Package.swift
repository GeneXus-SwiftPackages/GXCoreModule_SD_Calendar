...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.29.xcframework.zip",
			checksum: "64f830a98ac6189c135b3f43747a55b96e6e9e4f225c11638e17d4c91d8001ac"
		)
	]
)