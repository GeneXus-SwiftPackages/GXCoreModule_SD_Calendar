...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.2.0-beta.20.xcframework.zip",
			checksum: "fe0634c43236dd2ea686ec4f9165d0f505cee5caaa45bded5ad677e3eb7b72b7"
		)
	]
)