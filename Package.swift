...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.0.0-preview.20230715000002.xcframework.zip",
			checksum: "400b003d567f2c562d8d578b048ed68ebe7e5ab5038423281ec43f8f9da1b04b"
		)
	]
)