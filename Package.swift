...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.38.xcframework.zip",
			checksum: "e5ca8459399243fc2bf3e9a9457a27d45656c748a727fa549bd81be9d34b78c1"
		)
	]
)