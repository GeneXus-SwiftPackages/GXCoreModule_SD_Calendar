...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.11.xcframework.zip",
			checksum: "78a3b85bfbfc82c75cb63100ff40f201bda8d7f21bb4a258b7fd6fcfd2c39225"
		)
	]
)