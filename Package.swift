...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.12.xcframework.zip",
			checksum: "6363b94f38369ff78701827eba9ea0308f4aaf0ae0b6df03c5e780266cbc839e"
		)
	]
)