...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-4.2.0-rc.20.xcframework.zip",
			checksum: "4dfeca7224f53dfe6ffdd09f6ac677ec8212e691b4bef97dceaca42459d01ed2"
		)
	]
)