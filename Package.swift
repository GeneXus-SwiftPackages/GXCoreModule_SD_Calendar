...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.23.xcframework.zip",
			checksum: "add3a6cf56ac3e5f583108a2a84bc0c4b08ac0ca3eb15236c926c6cdd7b87743"
		)
	]
)