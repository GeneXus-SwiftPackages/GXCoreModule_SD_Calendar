...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.0.0-beta.48.xcframework.zip",
			checksum: "89105a09ee0f91c8e87381b82cea8083ddf7b94a9a14c7e09533be61b0fe7c9e"
		)
	]
)