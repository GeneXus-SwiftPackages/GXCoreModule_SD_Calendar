...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.4.0-rc.21.xcframework.zip",
			checksum: "0b3f0f7ba8c0b8e00786040779f5f73aff0a1239885059d6879cd32cfddd46c2"
		)
	]
)