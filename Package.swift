...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.14.xcframework.zip",
			checksum: "ed1f8c3d42e19cc02e3d58365d26be0d9ed2d5641c86b594fbd339919449e668"
		)
	]
)