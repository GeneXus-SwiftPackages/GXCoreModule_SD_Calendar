...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.27.xcframework.zip",
			checksum: "edda7e63813174284e5852c4467ffa42e807f9a20acb3a882f3b93b2e604d43c"
		)
	]
)