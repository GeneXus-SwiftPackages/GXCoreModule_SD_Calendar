...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-2.1.0-rc.23.xcframework.zip",
			checksum: "8918df60f46046fc1d087743791709d6d62dcb5d6211b57cda94b3b4e35f8e15"
		)
	]
)