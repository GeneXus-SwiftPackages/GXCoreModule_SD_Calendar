...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.27.xcframework.zip",
			checksum: "d4edb25704294f32081204acd56278571327dab2bcb889c017eba8bedd0f0d6b"
		)
	]
)