...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.2.0-beta.9.xcframework.zip",
			checksum: "35d662004e1c479d5526b04430368bc503ba2bbbf3fb0dea00e9672f0ac208db"
		)
	]
)