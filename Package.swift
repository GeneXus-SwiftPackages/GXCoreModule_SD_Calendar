...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.25.xcframework.zip",
			checksum: "f1fbb5af5841ff42fa4e1d8285967e72bd51192bdd60b434d5c40aea3d3ad785"
		)
	]
)