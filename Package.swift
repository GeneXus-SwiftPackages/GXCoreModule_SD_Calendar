...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.5.xcframework.zip",
			checksum: "25984782e5b6b24aac448eeb9d4f07e369c4a313233ca37d352d027cb5560b21"
		)
	]
)