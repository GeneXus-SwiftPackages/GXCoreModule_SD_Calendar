...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.9.xcframework.zip",
			checksum: "eb7e40c483b26401a1dd25d1d6b98093b4b070a2b416697e542a836ed0ce9226"
		)
	]
)