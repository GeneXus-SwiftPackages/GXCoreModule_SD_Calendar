...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.4.xcframework.zip",
			checksum: "ae2dfedff04b845e64953dab0de2be2600f7991d16791bd4c4e79109e89b9365"
		)
	]
)