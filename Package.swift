...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-3.2.0-rc.12.xcframework.zip",
			checksum: "10ab34b97a286609831b506f2223ea1d205aaef1ca0f231724f8906bf0118c7e"
		)
	]
)