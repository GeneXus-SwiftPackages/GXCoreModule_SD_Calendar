...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.18.xcframework.zip",
			checksum: "eec14c133ed127ba2e57f3e2be83f036cbde5d6d31c074cad315ff74f747c9f9"
		)
	]
)