...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.21.xcframework.zip",
			checksum: "702cd6eb2edf76a18cc64b292a5be582e151e0d85139f2bd4e5ca2fc4df0a02b"
		)
	]
)