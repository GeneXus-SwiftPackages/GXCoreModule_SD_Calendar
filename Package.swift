...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.0.0-beta.11.xcframework.zip",
			checksum: "ac70e3c7aadb480bf776aa3d98949738e80bdf9bc535e0dfedbc95571677e078"
		)
	]
)