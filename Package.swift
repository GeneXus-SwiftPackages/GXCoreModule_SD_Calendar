...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.0.0-beta.44.xcframework.zip",
			checksum: "a95ff489dada2c17f9f0bde7f35325c2b8887aba39e4501eb3c770fc0656c0a6"
		)
	]
)