...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.2.xcframework.zip",
			checksum: "3b16300fdc30630b0c63b7ea7598fc5eeed11f0d550a53119ed36378a0352d26"
		)
	]
)