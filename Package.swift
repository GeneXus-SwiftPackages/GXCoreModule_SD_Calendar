...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.24.xcframework.zip",
			checksum: "6eaebc6cf4514a017bb61c75afcccd6c5cdf7fce350d9250d098e4e9974cd0df"
		)
	]
)