...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.12.xcframework.zip",
			checksum: "e36405eb8318efb6add24e95fa30d6f6c102274773387b9fb91aaa924453c764"
		)
	]
)