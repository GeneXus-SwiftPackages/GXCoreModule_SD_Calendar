...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.7.xcframework.zip",
			checksum: "513e1fa7bdfc1c49ca43a26f76ea939438f6ba7a370421a2e4424d677a22145c"
		)
	]
)