...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.9.xcframework.zip",
			checksum: "a0c9b4c019615cbfdb9d8784bb44980b7c1354cfe38aabb1343bcb1df4e2c60c"
		)
	]
)