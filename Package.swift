...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.8.xcframework.zip",
			checksum: "1db834c3a5885af1fc3248aa470fb759f85720e33e2a1f03d91b5417dadbc4fe"
		)
	]
)