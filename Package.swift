...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.0.7.xcframework.zip",
			checksum: "e31819e057dcb9e0eb1e32e3f78b33cd0f19ba0ad4fc9798bc48e43a5528ad28"
		)
	]
)