...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.6.0-beta.3.xcframework.zip",
			checksum: "43ca3018609ab83e26df7dab317e0674bd4ac5733afd92c240a2b74cf48cd801"
		)
	]
)