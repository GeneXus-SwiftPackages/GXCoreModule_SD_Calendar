...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.29.xcframework.zip",
			checksum: "347deb32fa3a68191030a8c27cf52f6e270de3124a50baf8fbc089de6f5889f1"
		)
	]
)