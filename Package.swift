...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-5.0.0-beta.1.xcframework.zip",
			checksum: "7270cd8cda7cad6f07b3c2d5dda5a3b2e6df66c75741ad24dacf43a6ad176bd1"
		)
	]
)