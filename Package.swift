...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.0.0-beta.36.xcframework.zip",
			checksum: "48973e495e190927bedfc25fed42ab0ee451f4af1152ad430d9479a375a4e620"
		)
	]
)