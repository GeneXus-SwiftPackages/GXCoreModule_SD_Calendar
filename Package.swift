...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.2.xcframework.zip",
			checksum: "95f214fbf87be8e45611509fcc69566c8468fa3bbe81b1b2d0620bb6a877b36f"
		)
	]
)