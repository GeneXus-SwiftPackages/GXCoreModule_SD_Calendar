...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.2.0-rc.15.xcframework.zip",
			checksum: "751fd24a4ef1a52d880763d2f78121b5a653c51fa48270861ef4e4f24b821f63"
		)
	]
)