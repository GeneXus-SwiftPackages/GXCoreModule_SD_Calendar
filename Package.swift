...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.6.0-beta.2.xcframework.zip",
			checksum: "34ca92232721919666a6d1aae233e95302b3c30f54160006f72e11ae3cba917c"
		)
	]
)