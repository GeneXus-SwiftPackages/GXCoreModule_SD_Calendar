...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.21.xcframework.zip",
			checksum: "8866f8dca498e8066c0bca526d99a18bb098834802f4574d335e21965e4b9041"
		)
	]
)