...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.4.0-beta.16.xcframework.zip",
			checksum: "4fc13ecbe6959a8034bdc6a8df83c7d96c07791010b696c598058eb055d01c7a"
		)
	]
)