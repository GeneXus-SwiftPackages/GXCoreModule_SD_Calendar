...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.5.11.xcframework.zip",
			checksum: "58c5e6eb97fa46e588bb45ecc786366d218e1593e62c1bcc586667734e939315"
		)
	]
)