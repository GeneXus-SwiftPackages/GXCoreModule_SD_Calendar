...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.6.0-beta.4.xcframework.zip",
			checksum: "0d4f537ac75cefa221f2cf86f12c2e8e5da550c5ceb6b091a30bc7c72c604ec4"
		)
	]
)