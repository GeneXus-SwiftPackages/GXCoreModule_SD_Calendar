...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.10.xcframework.zip",
			checksum: "04a209e17eb1c73c3c7db3bbd2706be7538c1e594c8d2a8c59c7a4c113a27c23"
		)
	]
)