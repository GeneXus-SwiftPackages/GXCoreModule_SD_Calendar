...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.5.12.xcframework.zip",
			checksum: "3494738289c0cebcf0ccf31daefb0caf0657a97a82c3ad195b58db61984d5b1f"
		)
	]
)