...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.15.xcframework.zip",
			checksum: "a031f6442d2497a124f7708a7d138fea06c4b31c453d7b3a83437557f33c5aaf"
		)
	]
)