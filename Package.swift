...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.2.0-beta.30.xcframework.zip",
			checksum: "75bbe94aad98465ab9889def32d4427822efdbb98116f09a776cc9a489af6d96"
		)
	]
)