...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.17.xcframework.zip",
			checksum: "3bd7b701ad6336e943cf2456e38b98e06bb68d854ec669f573574846c67d0c7c"
		)
	]
)