...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-3.2.0.xcframework.zip",
			checksum: "55d7b0ca2b1ef98ffbd1e4a8984f6b796069c3b7cf857c0ea144b053e68c4269"
		)
	]
)