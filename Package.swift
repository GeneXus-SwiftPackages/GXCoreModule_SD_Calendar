...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.1.xcframework.zip",
			checksum: "bbb2325fba74145d137aff82d6fc3ed08491387770b88ff619b2184b5f8c726c"
		)
	]
)