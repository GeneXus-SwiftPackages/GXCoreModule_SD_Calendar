...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.0.0-beta.0.xcframework.zip",
			checksum: "f2fc8e9ae87f3f7fd1385b770863e2b0e567a7cdcc88a10c665f0fe2e9470dc7"
		)
	]
)