...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.13.xcframework.zip",
			checksum: "facc528c9d2c1e8608fa5f4c020f68cd76215a51934d10b2de5300e6e8089e4f"
		)
	]
)