...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-3.0.2.xcframework.zip",
			checksum: "88a11528c5e632300d94cafa5b2809641bd3d07406c8f48f5f51f6f91933d3f4"
		)
	]
)