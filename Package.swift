...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.34.xcframework.zip",
			checksum: "392bfec73ed96a8aadf923831f27098a7219be6f7fcd2233818badfad6a53daf"
		)
	]
)