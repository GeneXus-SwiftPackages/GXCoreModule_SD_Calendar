...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.5.0-beta.3.xcframework.zip",
			checksum: "0d680bedadc8a41540e832b567b88e84f4eb2093293e6ac238ebfde5384c1432"
		)
	]
)