...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.24.xcframework.zip",
			checksum: "d7db79942671586530c417ed67109b45497266133b8efb7303daeedf777361cf"
		)
	]
)