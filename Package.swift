...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.2.0-beta.20.xcframework.zip",
			checksum: "6d78408ed98ccb4c7d85d1f19cd24ff78926396eb99612a4d76cdd2c21745a78"
		)
	]
)