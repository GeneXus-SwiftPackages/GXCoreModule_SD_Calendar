...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.3.0-beta.6.xcframework.zip",
			checksum: "6a0fe7cc5a1028bd5f647efda0e6b27b0d6759241c32146be71874863274a5c0"
		)
	]
)