...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.2.1.xcframework.zip",
			checksum: "47ef22ebd301c826799082c97034e2f5c4b3991f3d8b7ad3f4cfc10eb29d4a4f"
		)
	]
)