...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.1.0-beta.13.xcframework.zip",
			checksum: "ce4bbb9441da86eb70ab7b8447d59d4362f93ceeecdaf2492b493afbc0109d09"
		)
	]
)