...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-4.1.3.xcframework.zip",
			checksum: "4ed7da09ebe827e649a2a214e36bdea803e196ebb40559d3258b1e946d8b7a01"
		)
	]
)