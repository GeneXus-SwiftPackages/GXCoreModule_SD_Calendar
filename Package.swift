...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.6.xcframework.zip",
			checksum: "9ae373a07d8f193aa4a67f20bb511ded2f7071b6ca28bd39c83d159b94d31e22"
		)
	]
)