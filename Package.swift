...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-3.0.0-rc.15.xcframework.zip",
			checksum: "2bbbfc78218d10868a1017c921304f309f116cc9c28630e14035fedbc743fe2e"
		)
	]
)