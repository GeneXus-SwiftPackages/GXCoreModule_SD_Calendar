...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.0.0-beta.51.xcframework.zip",
			checksum: "0bd004e69251cdd712a3a2b92253e763a5f14382accdc51ded0764cd06c7ab40"
		)
	]
)