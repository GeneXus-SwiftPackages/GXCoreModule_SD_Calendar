...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Calendar-1.3.0-rc.7.xcframework.zip",
			checksum: "5c156e8ada6dd59fb5ec164325825dcf0c9cd80768fe87d24e109028701550cf"
		)
	]
)