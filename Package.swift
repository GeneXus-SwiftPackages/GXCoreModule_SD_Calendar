...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-3.2.0-beta.37.xcframework.zip",
			checksum: "895c9c13c61bb539042b607f33630b8a7a8f9899f9e3070590c65547bdb23219"
		)
	]
)