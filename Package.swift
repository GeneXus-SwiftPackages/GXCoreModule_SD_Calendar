...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-1.2.0.xcframework.zip",
			checksum: "cc22f0d752568d434cb3f3f735cdf1304b922f819cdc642195bb043ecb87da28"
		)
	]
)