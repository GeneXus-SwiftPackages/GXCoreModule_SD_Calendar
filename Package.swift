...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-4.1.0-beta.8.xcframework.zip",
			checksum: "d8c74ded303588b7ba949651006a551fe34bbbb79c8701d5536ccb2d417775cb"
		)
	]
)