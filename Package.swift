...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.6.0-beta.0.xcframework.zip",
			checksum: "98bfe75106333947f11e23402b7aa8270de05e349c625682fdb0e20b05f75e33"
		)
	]
)