...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-1.2.0-beta.10.xcframework.zip",
			checksum: "67d560bc876f0b99ec950be7a66c582edc0aba2f45eb7afd010130959628cf20"
		)
	]
)