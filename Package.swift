...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Calendar-3.0.3.xcframework.zip",
			checksum: "ded6e153b302b08f06e2f52cbafb0fbd4aa5caa4c02470a2aebbaa6f81052976"
		)
	]
)