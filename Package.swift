...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.0.0-beta.41.xcframework.zip",
			checksum: "5ba5c7e66646c1be54321dee33bb885f5a92ac6e3fc048109d9619b3aa479243"
		)
	]
)