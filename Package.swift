...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Calendar",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Calendar-2.0.0-beta.27.xcframework.zip",
			checksum: "f514a9ad49ca231ea28a2069e794df50d48887bdd2004a1b07361be70ca55a83"
		)
	]
)